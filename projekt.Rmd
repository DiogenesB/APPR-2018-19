...
1. `narocila` - podatki o vseh naročilih na portalu
  ...
  - `pravocasnost` - meritev: Ali je bilo naročilo dostavljeno v predvidenem roku dostave (TRUE, FALSE)
...
ggplot(promet_2017, aes(x = promet_2017$mesec.dostave, y = promet_2017$vrednost.placila)) + geom_bar(stat = "identity") + labs(title = "Pregled prometa v letu 2017", x = "Mesec", y = "Skupni promet")
```
